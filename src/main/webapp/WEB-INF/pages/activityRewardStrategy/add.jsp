    ...
    <div class="col-md-12">
      <div class="panel panel-default">
            <div class="panel-body">
              <h3 style="margin-top: 0px" class="title">新建活动奖励策略</h3>
            </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-title">
         ...
         <div class="panel-body">
              <form class="form-horizontal"  action="<%=path%>/activityRewardStrategy/save" id="addActivityRewardStrategy" onsubmit="return save()" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input style="width: 220px" type="text" class="form-control" name="rewardStrategyName" id="rewardStrategyName">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input style="width: 220px" type="text" class="selectdate" name="rewardGrantStartTime" id="rewardGrantStartTime">
                  </div>
                </div>
                <div class="form-group">
                  <label for="rewardGrantEndTime" class="col-sm-1 control-label form-label">奖励发放终止时间</label>
                  <div class="col-sm-8">
                    <input style="width: 220px" type="text" class="selectdate"  name="rewardGrantEndTime" id="rewardGrantEndTime">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <div class="radio">
                      ...
                      <input name="activityImgUrl" id="activityImgUrl" value="" type="hidden">
                    </div>
                    ...
                    <!--存放关联的活动Id-->
                    <input name="activityIds" id="activityIds" value="" type="hidden">
                    <!--存放关联的活动名称-->
                    <input name="activityName" id="activityName" value="" type="hidden">
                    <!--存放奖励方式值-->
                    <input name="rewardWay" value="1" id="rewardWay" type="hidden">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input style="width: 220px" type="text" class="form-control" name="rewardPoints" id="rewardPoints">
                  </div>
                </div>
                <div class="form-group">
                  <label for="rewardStrategyName" class="col-sm-1 control-label form-label">策略说明</label>
                  <div class="col-sm-8">
                    <textarea id="strategyOn" style="height: 150px;width: 60%"  name="strategyOn"></textarea>
                  </div>
                </div>
