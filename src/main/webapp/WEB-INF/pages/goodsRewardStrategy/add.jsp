    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-title">
         ...
         <div class="panel-body">
              <form class="form-horizontal"  action="<%=path%>/goodsRewardStrategy/save" id="addActivityRewardStrategy" onsubmit="return save()" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <div class="radio radio-warning">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;共选择了<span id="number">0</span>件商品
                ...
                <!--商品列表 -->
                  <div class="form-group">
                      ...
                      <!--存放关联的商品Id-->
                      <input name="goodsIds" id="goodsIds" value="" type="hidden">
                      <input name="names" id="names" value="" type="hidden">
                      <input name="topcatids" id="topcatids" value="" type="hidden">
                      <input name="topcatnames" id="topcatnames" value="" type="hidden">
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-sm-8">
                          <input style="width: 220px" type="text" class="form-control" name="goodsRewardRatio" id="goodsRewardRatio">
                      </div>
                  </div>
