      ...
      <div class="panel panel-default">
            <div class="panel-body">
              ...
              <div class="col-md-12 col-lg-6" style="padding-left:0px">
                ...
                <a href="<%=path%>/activityRewardStrategy/listView" class="btn btn-rounded btn-light">返回</a>
              </div>
              <!-- End right -->
            </div>
      </div>
         ...
         <div class="panel-body">
              <form class="form-horizontal" id="addHealthThemeTemplate">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                      <select class="rewardObject"  name="mainProblem" id="rewardObject">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <div class="radio">
                      <input type="radio" name="rewardWay" id="radio1" value="1" checked>
                      <label for="radio1">
                        用户登录即领
                      </label>
                    ...
                    <div class="radio radio-warning">
                      <input type="radio" name="rewardWay" id="radio2" value="2">
                      <label for="radio2">
                      用户通过活动领取
                      </label>
                      <a style="cursor:pointer;margin-left: 30px">关联活动</a>
                    </div>
                  </div>
                </div>
                <div class="form-group">
