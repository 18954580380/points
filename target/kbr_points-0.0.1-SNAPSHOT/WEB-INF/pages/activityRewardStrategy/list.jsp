...
<head>
    ...
    <script type="text/javascript">
        ...
        function updateById() {
            ...
            strs = ids.split(","); //字符分割
            if (strs.length > 1) {
                layer.msg("无法同时对多个主题进行修改");
                return false;
            }
            window.location.href = "<%=path%>/healthTheme/updateById?id=" + ids
        }*/
    </script>
</head>
...
<script>
    ...
    var column = [
       ...
       "rewardStrategyName",
        ...
        "status",
        function(data){
            return   data.activeImgUrl=="" || data.activeImgUrl==null ?"无":data.activeImgUrl;
        },
        function(data){
            var str="<a>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a>删除</a>"
            return   str;
        },
