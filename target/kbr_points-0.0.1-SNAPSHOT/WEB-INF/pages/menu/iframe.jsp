    ...
    <ul class="sidebar-panel nav" style="    width: 100%;margin: 0px;border: none;padding-top: 0px;">
        ...
        <li>
            ...
            <ul class="nav_nav2_ul" >
                ...
                <li><a href="<%=path%>/testFirst/dataAnalysis" target="showframe">商品奖励策略</a></li>
            </ul>
        </li>
     ...
     <li>
            ...
            <ul class="nav_nav2_ul" >
                <li><a href="<%=path%>/testFirst/dailyInspection" target="showframe">投放积分</a></li>
                <li><a href="<%=path%>/testFirst/dataAnalysis" target="showframe">设置</a></li>
            </ul>
        </li>
    </ul>
    </h6>
